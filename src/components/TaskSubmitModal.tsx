        ...
        <form onSubmit={handleSubmit} className="p-6 overflow-y-auto space-y-4 text-xs">
          ...
          <div className="p-3.5 bg-slate-50 border border-slate-200/80 rounded-xl space-y-1.5">
            ...
            <div className="flex items-center justify-between text-[11px] pt-1">
              ...
              <span className="text-emerald-700 font-bold">Reward: ₹{task.rewardAmount}*</span>
            </div>
          </div>
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-3.5 py-2 rounded-xl border border-slate-300 focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-600 text-xs text-slate-800"
            />
          </div>
            ...
            {screenshotPreview ? (
              <div className="relative rounded-xl border border-slate-200 p-2 bg-slate-50">
                ...
                <button
                  ...
                  className="absolute top-4 right-4 bg-slate-900/80 hover:bg-slate-900 text-white text-[10px] px-2 py-1 rounded-md font-bold"
                >
                  Change
                </button>
              </div>
            ) : (
              <label className="border-2 border-dashed border-slate-300 hover:border-emerald-500 rounded-xl p-6 flex flex-col items-center justify-center cursor-pointer bg-slate-50 hover:bg-emerald-50/30 transition-colors">
          ...
          <div className="pt-2 flex items-center justify-end gap-2.5">
            ...
            <button
              ...
              type="submit"
              disabled={submitting}
              className="px-5 py-2.5 bg-emerald-600 hover:bg-emerald-700 text-white font-bold text-xs rounded-xl shadow-xs transition-colors flex items-center gap-1.5 disabled:opacity-50"
            >
