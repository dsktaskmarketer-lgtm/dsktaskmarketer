...
export const PublicTaskPageView: React.FC<PublicTaskPageViewProps> = ({
  ...
  if (!task) {
    return (
      <div className="w-full px-4 md:px-6 py-16 text-center space-y-5">
  ...
  return (
    <div className="w-full px-4 md:px-6 py-8 sm:py-12 space-y-8 animate-in fade-in duration-200">
