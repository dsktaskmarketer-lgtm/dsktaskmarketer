              ...
              <tbody className="divide-y divide-slate-100">
                {filtered.map(sub => (
                  <tr key={sub.id} className="hover:bg-slate-50/60 transition-colors">
                    ...
                    <td className="py-4 px-4 font-bold text-emerald-800 text-sm">
                      ₹{sub.rewardAmount}*
                    </td>
                    ...
                    <td className="py-4 px-6 text-right">
                      <button
                        ...
                        className="px-2.5 py-1.5 rounded-lg border border-slate-200 bg-white hover:bg-slate-50 text-slate-700 font-semibold text-[11px] inline-flex items-center gap-1 transition-colors"
                      >
